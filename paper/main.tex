...
\midrule
n\_variables & 0.851 & $2.7\times10^{-7}$ & 0.859 & $1.5\times10^{-7}$ \\
corridor\_diameter\_hops & \textbf{0.859} & $1.5\times10^{-7}$ & \textbf{0.849} & $3.0\times10^{-7}$ \\
route\_hops\_mean & 0.715 & $1.3\times10^{-4}$ & 0.741 & $5.2\times10^{-5}$ \\
structural\_critical\_bridge\_count & 0.730 & $7.6\times10^{-5}$ & 0.729 & $8.0\times10^{-5}$ \\
structural\_bridge\_count & 0.638 & $1.1\times10^{-3}$ & 0.618 & $1.7\times10^{-3}$ \\
capacity\_bottleneck\_edge\_count & 0.667 & $5.1\times10^{-4}$ & 0.709 & $1.5\times10^{-4}$ \\
traffic\_bottleneck\_top1\_share & 0.702 & $1.9\times10^{-4}$ & 0.687 & $2.9\times10^{-4}$ \\
\bottomrule
\end{tabular}
\end{table}

The interesting result is not that corridor diameter beats size outright, but that it is essentially \emph{as informative as size while capturing something size does not}, confirmed directly by the regression below. Critically, our original working hypothesis -- that critical-bridge count drives difficulty -- does not order the three controlled topologies correctly. At matched room counts, Tree has 4--5$\times$ more critical bridges than Loop (17 vs.\ 4 at 20 rooms; 30 vs.\ 6 at 30 rooms) yet a \emph{smaller} optimality gap both times (Table~\ref{tab:synthetic}, an illustrative subset of the full 18-floorplan results in Tables~\ref{tab:appendixb} and~\ref{tab:appendixb2}). Corridor diameter and mean route length, by contrast, correctly order all three topologies (Tree $<$ Loop $<$ Linear) at every size tested.
...
Tree & 10 & 2 & 20 & 7 & 35 & 11 \\
Tree & 20 & 4 & 80 & 7 & 65 & 17 \\
Tree & 30 & 6 & 180 & 11 & 107 & 30 \\
Loop & 10 & 2 & 20 & 4 & 22 & 2 \\
Loop & 20 & 4 & 80 & 8 & 44 & 4 \\
...
Linear & 30 / S2 & 0.2428 & 129.83\% & 101.37\% \\
Tree & 10 / S1 & 1.7241 & $-$0.00\% & $-$0.00\% \\
Tree & 10 / S2 & 1.6876 & $-$0.00\% & $-$0.00\% \\
Tree & 20 / S1 & 1.1002 & 8.74\% & 5.39\% \\
Tree & 20 / S2 & 1.0437 & 8.59\% & 4.82\% \\
Tree & 30 / S1 & 0.7397 & 27.90\% & 21.75\% \\
Tree & 30 / S2 & 0.7959 & 23.14\% & 17.06\% \\
Loop & 10 / S1 & 3.0133 & $-$0.00\% & $-$0.00\% \\
Loop & 10 / S2 & 2.8944 & $-$0.10\% & $-$0.12\% \\
Loop & 20 / S1 & 0.7147 & 22.54\% & 15.07\% \\
Loop & 20 / S2 & 0.6670 & 20.88\% & 12.19\% \\
Loop & 30 / S1 & 0.4056 & 65.62\% & 53.53\% \\
Loop & 30 / S2 & 0.4216 & 65.37\% & 50.48\% \\
\bottomrule
\end{tabular}
\end{table}

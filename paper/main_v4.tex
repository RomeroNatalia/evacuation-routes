...
\textbf{[v4 -- done]} The diagonal-edge correction (Section~\ref{sec:v4-diagonal}) is now complete for both solvers. The remaining decision is whether to replace Tables~\ref{tab:correlations}, \ref{tab:synthetic}, and \ref{tab:appendixb2} outright with the V2 numbers in a future version, versus keeping both corpora side by side as this draft does -- a judgment call for the co-authors, not a technical blocker.

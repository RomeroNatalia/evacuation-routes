...
4. Submits the BQM to D-Wave LeapHybridSampler.
...
Run from the repository root:
    ...
    python scripts/solve_qubo_hybrid.py
...
def solve_with_hybrid(bqm):
    """Submit the normalized BQM to D-Wave's Leap hybrid BQM solver."""
    sampler = LeapHybridSampler()
    return sampler.sample(bqm, label=HYBRID_LABEL)
...
def main() -> None:
    ...
    sampleset = solve_with_hybrid(bqm)
    ...
    print("\nOFFICE EVACUATION QUBO HYBRID RUN COMPLETE")
    print("=" * 48)

...
4. Repeats the solver across independent runs (10 by default).
...
Run from the repository root:
    ...
    python scripts/benchmark_qubo_neal.py

Optionally choose a different number of runs:

    python scripts/benchmark_qubo_neal.py 10
...
Generated outputs:
    ...
    data/floorplans/FPXX/output/qubo_neal/benchmark_runs.csv
    data/floorplans/FPXX/output/qubo_neal/benchmark_summary.csv
...
def main() -> None:
    ...
    print(f"\nRunning {run_count} independent simulated-annealing trials...")
    benchmark_rows = []
    run_results = []
    ...
    print("\nOFFICE EVACUATION QUBO BENCHMARK COMPLETE")
    print("=" * 48)
    print("Solver:                 neal.SimulatedAnnealingSampler")
